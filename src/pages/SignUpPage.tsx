...
export default function SignUpPage() {
  ...
  const signUp = async (
    ...
    try {
      ...
      if (error) {
        setErrors((prev) => ({
          ...prev,
          general: "Erreur lors de l'inscription : " + error.message,
        }));
        return;
      }
      ...
      if (!data?.session) {
        setErrors((prev) => ({
          ...prev,
          success:
            "Inscription réussie ! Veuillez vérifier votre boîte de réception pour confirmer votre email.",
          general: undefined,
        }));
        // Optionally delay navigation or keep user on page to read the message
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    setErrors((prev) => ({ ...prev, general: undefined, success: undefined }));
      ...
      <div className="signup-card">
        ...
        <form className="signup-form" onSubmit={handleSubmit} noValidate>
            ...
            <div className="form-group">
              ...
              <div className="input-wrapper">
                ...
                <input
                  ...
                  onChange={handleChange}
                  className={`no-icon-input ${errors.lastName ? "error-input" : ""}`}
                  required
                />
              </div>
              {errors.lastName && (
          ...
          <div className="form-group">
            ...
            <div
              className={`password-criteria ${formData.password.length >= 8 ? "valid" : "invalid"}`}
            >
